...
__Flame graph&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Caller/Callee__
...
### Версия omg_v5
И тут мне пришло в голову посмотреть на график коллизий моей `polinom_hash_func`. Без комментариев.

![poly perf hist](/results/screenshots/badhash.png)
...
```bash
runexec --read-only-dir / --container --overlay-dir . --memlimit 4GB --cores 0-1 -- ./build/v2 -h=cr32 -r=3 -m=100
```
