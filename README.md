...
* `VERSION_O0`    - версия без оптимизаций (VERSION_0)
* `VERSION_03` - версия с компиляторными оптимизациями (VERSION_1)
* `VERSION_INTINSIC` - версия с intrinsic оптимизацией функции cr32 (VERSION_2)
* `VERSION_MY_STREQ` - версия с использованием собственной реализацией функции streq на ассемблере (VERSION_3)
* `VERSION_ASM_INSERTION_STREQ` - версия с использованием inline функции streq с ассемблерными вставками (VERSION_4)
